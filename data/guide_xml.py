...
LANDING_DEMO_EN = program(
    "<variables><variable id=\"v_ld_name\">name</variable></variables>",
    '<block type="variables_set" x="20" y="20">',
    '<field name="VAR" id="v_ld_name">name</field>',
    '<value name="VALUE"><block type="text"><field name="TEXT">Anna</field></block></value>',
    "<next>",
    '<block type="text_print">',
    '<value name="TEXT">',
    '<block type="text_join">',
    ...
    '<value name="ADD1"><block type="variables_get"><field name="VAR" id="v_ld_name">name</field></block></value>',
    "</block>",
    "</value>",
    "</block>",
    "</next>",
...
STEP_CONNECT_DEMO_EN = program(
    "<variables><variable id=\"v_sc_name\">name</variable></variables>",
    '<block type="variables_set" x="20" y="20">',
    '<field name="VAR" id="v_sc_name">name</field>',
    '<value name="VALUE"><block type="text"><field name="TEXT">Anna</field></block></value>',
    "<next>",
    '<block type="text_print" x="20" y="20">',
...
# --- English guide examples (block field text) ---
IO_HELLO_EN = HELLO_WORLD

IO_WELCOME_EN = program(
    '<block type="text_print" x="20" y="20">',
    '<value name="TEXT"><block type="text"><field name="TEXT">Welcome!</field></block></value>',
    "</block>",
)

IO_VARIABLE_EN = program(
    "<variables><variable id=\"v_name\">name</variable></variables>",
    '<block type="variables_set" x="20" y="20">',
    '<field name="VAR" id="v_name">name</field>',
    '<value name="VALUE"><block type="text"><field name="TEXT">Anna</field></block></value>',
    "<next>",
    '<block type="text_print">',
    '<value name="TEXT"><block type="variables_get"><field name="VAR" id="v_name">name</field></block></value>',
    "</block>",
    "</next>",
    "</block>",
)

IO_GREETING_EN = program(
    "<variables><variable id=\"v_name\">name</variable></variables>",
    '<block type="variables_set" x="20" y="20">',
    '<field name="VAR" id="v_name">name</field>',
    '<value name="VALUE"><block type="py_input"><field name="PROMPT">What is your name?</field></block></value>',
    "<next>",
    '<block type="text_print">',
    '<value name="TEXT">',
    '<block type="text_join">',
    '<mutation items="2"></mutation>',
    '<value name="ADD0"><block type="text"><field name="TEXT">Hello, </field></block></value>',
    '<value name="ADD1"><block type="variables_get"><field name="VAR" id="v_name">name</field></block></value>',
    "</block>",
    "</value>",
    "</block>",
    "</next>",
...
NUMS_PERIMETER_EN = program(
    "<variables><variable id=\"v_p\">perimeter</variable></variables>",
    '<block type="variables_set" x="20" y="20">',
    '<field name="VAR" id="v_p">perimeter</field>',
    f'<value name="VALUE">{bin_op("py_mul", num(2), bin_op("py_add", num(7), num(3)))}</value>',
    "<next>",
    '<block type="text_print">',
    f'<value name="TEXT">{var_get("v_p", "perimeter")}</value>',
    "</block>",
    "</next>",
    "</block>",
)

NUMS_INPUT_SUM_EN = program(
    "<variables><variable id=\"v_a\">a</variable><variable id=\"v_b\">b</variable></variables>",
    '<block type="variables_set" x="20" y="20">',
    '<field name="VAR" id="v_a">a</field>',
    '<value name="VALUE"><block type="py_convert">',
    '<value name="VALUE"><block type="py_input"><field name="PROMPT">First number</field></block></value>',
    '<field name="TO">INT</field>',
    "</block></value>",
    "<next>",
    '<block type="variables_set">',
    '<field name="VAR" id="v_b">b</field>',
    '<value name="VALUE"><block type="py_convert">',
    '<value name="VALUE"><block type="py_input"><field name="PROMPT">Second number</field></block></value>',
    '<field name="TO">INT</field>',
    "</block></value>",
    "<next>",
    '<block type="text_print">',
...
COND_COMPARE_DEMO_EN = program(
    ...
    "</block></value>",
    '<statement name="DO0"><block type="text_print">',
    '<value name="TEXT"><block type="text"><field name="TEXT">true</field></block></value>',
    "</block></statement>",
    '<statement name="ELSE"><block type="text_print">',
    '<value name="TEXT"><block type="text"><field name="TEXT">false</field></block></value>',
    "</block></statement>",
    "</block>",
)

COND_LOGIC_AND_EN = program(
    '<block type="py_ifelse" x="20" y="20">',
    '<value name="IF0"><block type="logic_operation">',
    '<field name="OP">AND</field>',
    '<value name="A"><block type="logic_compare">',
    ...
    "</block></value>",
    '<statement name="DO0"><block type="text_print">',
    '<value name="TEXT"><block type="text"><field name="TEXT">yes</field></block></value>',
    "</block></statement>",
    '<statement name="ELSE"><block type="text_print">',
    '<value name="TEXT"><block type="text"><field name="TEXT">no</field></block></value>',
    "</block></statement>",
    "</block>",
)

COND_IF_ELSE_AGE_EN = program(
    "<variables><variable id=\"v_age\">age</variable></variables>",
    '<block type="variables_set" x="20" y="20">',
    ...
    '<value name="IF0"><block type="logic_compare">',
    '<field name="OP">GTE</field>',
    '<value name="A"><block type="variables_get"><field name="VAR" id="v_age">age</field></block></value>',
    '<value name="B"><block type="math_number"><field name="NUM">18</field></block></value>',
    "</block></value>",
    '<statement name="DO0"><block type="text_print">',
    '<value name="TEXT"><block type="text"><field name="TEXT">allowed</field></block></value>',
    "</block></statement>",
    '<statement name="ELSE"><block type="text_print">',
    '<value name="TEXT"><block type="text"><field name="TEXT">not allowed</field></block></value>',
    "</block></statement>",
    "</block>",
    "</next>",
    "</block>",
...
COND_EVEN_EN = program(
    ...
    "</block></value>",
    '<statement name="DO0"><block type="text_print">',
    '<value name="TEXT"><block type="text"><field name="TEXT">even</field></block></value>',
    "</block></statement>",
    '<statement name="ELSE"><block type="text_print">',
    '<value name="TEXT"><block type="text"><field name="TEXT">odd</field></block></value>',
    "</block></statement>",
    "</block>",
    "</next>",
    "</block>",
...
COND_WEATHER_EN = program(
    "<variables><variable id=\"v_t\">warm</variable><variable id=\"v_d\">rain</variable></variables>",
    '<block type="variables_set" x="20" y="20">',
    '<field name="VAR" id="v_t">warm</field>',
    '<value name="VALUE"><block type="logic_boolean"><field name="BOOL">TRUE</field></block></value>',
    "<next>",
    '<block type="variables_set">',
    '<field name="VAR" id="v_d">rain</field>',
    '<value name="VALUE"><block type="logic_boolean"><field name="BOOL">FALSE</field></block></value>',
    "<next>",
    '<block type="py_ifelse">',
    '<value name="IF0"><block type="logic_operation">',
    '<field name="OP">AND</field>',
    '<value name="A"><block type="variables_get"><field name="VAR" id="v_t">warm</field></block></value>',
    '<value name="B"><block type="logic_negate">',
    '<value name="BOOL"><block type="variables_get"><field name="VAR" id="v_d">rain</field></block></value>',
    "</block></value>",
    "</block></value>",
    '<statement name="DO0"><block type="text_print">',
    '<value name="TEXT"><block type="text"><field name="TEXT">let\'s go for a walk!</field></block></value>',
    "</block></statement>",
    '<statement name="ELSE"><block type="text_print">',
    '<value name="TEXT"><block type="text"><field name="TEXT">staying home</field></block></value>',
    "</block></statement>",
    "</block>",
    "</next>",
    "</block>",
...
WHILE_SUM_EN = program(
    "<variables><variable id=\"v_i\">i</variable><variable id=\"v_s\">total</variable></variables>",
    '<block type="variables_set" x="20" y="20">',
    '<field name="VAR" id="v_s">total</field>',
    '<value name="VALUE"><block type="math_number"><field name="NUM">0</field></block></value>',
    "<next>",
    '<block type="variables_set">',
    '<field name="VAR" id="v_i">i</field>',
    ...
    '<block type="variables_set">',
    '<field name="VAR" id="v_s">total</field>',
    f'<value name="VALUE">{bin_op("py_add", var_get("v_s", "total"), var_get("v_i", "i"))}</value>',
    "<next>",
    '<block type="variables_set">',
    '<field name="VAR" id="v_i">i</field>',
    f'<value name="VALUE">{bin_op("py_add", var_get("v_i", "i"), num(1))}</value>',
    ...
    "<next>",
    '<block type="text_print">',
    '<value name="TEXT"><block type="variables_get"><field name="VAR" id="v_s">total</field></block></value>',
    "</block>",
    "</next>",
    "</block>",
    "</block>",
...
STR_UPPER_EN = program(
    "<variables><variable id=\"v_s\">word</variable></variables>",
    '<block type="variables_set" x="20" y="20">',
    '<field name="VAR" id="v_s">word</field>',
    '<value name="VALUE"><block type="text"><field name="TEXT">python</field></block></value>',
    "<next>",
    '<block type="text_print">',
    '<value name="TEXT"><block type="py_str_upper">',
    '<value name="OBJ"><block type="variables_get"><field name="VAR" id="v_s">word</field></block></value>',
    "</block></value>",
    "</block>",
    "</next>",
    "</block>",
...
STR_JOIN_EN = program(
    ...
    '<mutation items="2"></mutation>',
    '<value name="ADD0"><block type="text"><field name="TEXT">Hello</field></block></value>',
    '<value name="ADD1"><block type="text"><field name="TEXT">, world!</field></block></value>',
    "</block>",
    "</value>",
    "</block>",
)

STR_INPUT_UPPER_EN = program(
    "<variables><variable id=\"v_s\">s</variable></variables>",
    '<block type="variables_set" x="20" y="20">',
    '<field name="VAR" id="v_s">s</field>',
    '<value name="VALUE"><block type="py_input"><field name="PROMPT">Enter a word</field></block></value>',
    "<next>",
    '<block type="text_print">',
    '<value name="TEXT"><block type="py_str_upper">',
    '<value name="OBJ"><block type="variables_get"><field name="VAR" id="v_s">s</field></block></value>',
...
LIST_CREATE_EN = program(
    "<variables><variable id=\"v_f\">fruits</variable></variables>",
    '<block type="variables_set" x="20" y="20">',
    '<field name="VAR" id="v_f">fruits</field>',
    '<value name="VALUE"><block type="lists_create_with">',
    '<mutation items="3"></mutation>',
    '<value name="ADD0"><block type="text"><field name="TEXT">apple</field></block></value>',
    '<value name="ADD1"><block type="text"><field name="TEXT">banana</field></block></value>',
    '<value name="ADD2"><block type="text"><field name="TEXT">pear</field></block></value>',
    "</block></value>",
    "<next>",
    '<block type="text_print">',
    '<value name="TEXT"><block type="lists_getIndex">',
    ...
    '<field name="MODE">GET</field>',
    '<field name="WHERE">FROM_START</field>',
    '<value name="VALUE"><block type="variables_get"><field name="VAR" id="v_f">fruits</field></block></value>',
    '<value name="AT"><block type="math_number"><field name="NUM">1</field></block></value>',
    "</block></value>",
    "</block>",
    "</next>",
...
LIST_SUM_EN = program(
    "<variables><variable id=\"v_n\">numbers</variable><variable id=\"v_x\">x</variable><variable id=\"v_s\">total</variable></variables>",
    '<block type="variables_set" x="20" y="20">',
    '<field name="VAR" id="v_n">numbers</field>',
    '<value name="VALUE"><block type="lists_create_with">',
    '<mutation items="3"></mutation>',
    '<value name="ADD0"><block type="math_number"><field name="NUM">10</field></block></value>',
    '<value name="ADD1"><block type="math_number"><field name="NUM">20</field></block></value>',
    ...
    '<block type="py_for">',
    '<field name="VAR" id="v_x">x</field>',
    '<value name="SEQ"><block type="variables_get"><field name="VAR" id="v_n">numbers</field></block></value>',
    '<statement name="DO"><block type="variables_set">',
    '<field name="VAR" id="v_s">total</field>',
    f'<value name="VALUE">{bin_op("py_add", var_get("v_s", "total"), var_get("v_x", "x"))}</value>',
    "</block></statement>",
    "</block>",
    "<next>",
    '<block type="text_print">',
